...
name: warp
description: >
  NVIDIA Warp onboarding - high-performance Python framework for GPU kernels,
  differentiable simulation, and spatial computing. Use when: installing Warp,
  writing @wp.kernel functions, learning arrays/launches/thread indexing,
  using mesh/volume/BVH spatial primitives, building differentiable simulations
  with wp.Tape, running examples, debugging issues, or integrating with
  PyTorch/JAX/NumPy.
---
...
3. [basics.md](basics.md)
4. [kernels.md](kernels.md)
5. [examples/core.md](examples/core.md)
6. [meshing.md](meshing.md)
