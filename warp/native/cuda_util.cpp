...
CUresult cuOccupancyMaxPotentialBlockSize_f(
    int* minGridSize, int* blockSize, CUfunction func, size_t dynamicSMemSize, int blockSizeLimit
)
{
    return pfn_cuOccupancyMaxPotentialBlockSize ? pfn_cuOccupancyMaxPotentialBlockSize(minGridSize, blockSize, func, NULL, dynamicSMemSize, blockSizeLimit)
                                                : DRIVER_ENTRY_POINT_ERROR;
}
